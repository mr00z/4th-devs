...
const logFile = path.join(paths.logsDir, `filesystem-${timestamp}.log`)
const workspaceRunDir = path.join(paths.workspaceDir, `filesystem-${timestamp}`)
...
appendFile('INFO', '=== FILESYSTEM SESSION START ===')
